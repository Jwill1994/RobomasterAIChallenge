...
class Referee1vs1:
    def __init__(self):
        ...
        self.robot3=Robot(robot_name="robot_3",team="blue")
        ...
        self.shoot_server_2 = rospy.Service("robot_2"+'/referee_shoot_service',RefereeShoot,self.ShootCB_2)
        self.shoot_server_3 = rospy.Service("robot_3"+'/referee_shoot_service',RefereeShoot,self.ShootCB_3)
    ...
    def PlayInit(self):
        ...
        self.robot2.hp = self.start_hp
        self.robot3.hp = self.start_hp
        RefereeGameStateClient(2,"robot_0")
        RefereeGameStateClient(2,"robot_1")
        RefereeGameStateClient(2,"robot_2")
        RefereeGameStateClient(2,"robot_3")
    ...
    def Play(self):
        ...
        if self.robot2.is_reloading :
            if( (rospy.Time.now() - self.robot2.reload_time).to_sec() > 5 ):
                RefereeReloadClient("robot_2")
                self.robot2.is_reloading=False
        if self.robot3.is_reloading :
        ...
        if (self.robot0.hp <= 0 or self.robot1.hp <= 0):
            RefereeGameStateClient(3,"robot_0")
            RefereeGameStateClient(3,"robot_1")
            RefereeGameStateClient(3,"robot_2")
            RefereeGameStateClient(3,"robot_3")
        ...
        elif (self.robot2.hp <= 0 or self.robot3.hp <= 0):
            RefereeGameStateClient(3,"robot_0")
            RefereeGameStateClient(3,"robot_1")
            RefereeGameStateClient(3,"robot_2")
            RefereeGameStateClient(3,"robot_3")
    ...
    def ReadyInit(self):
        ...
        RefereeGameStateClient(1,"robot_2")
        RefereeGameStateClient(1,"robot_3")
    ...
    def ShootCB_1(self,req):
        ...
        point.header.stamp = rospy.Time.now()
        point.header.frame_id = "referee_map"
        point.point.x= req.x ## 8-req.x
        point.point.y= req.y ##5-req.y
        point.point.z= 0.1
    ...
    def ShootCB_2(self,req):
        ...
        self.robot2.shootmark_pub.publish(point)
        if req.x < -4 and req.y < -4:
            return RefereeShootResponse(5,True)
    ...
    def ShootCB_3(self,req):
        ...
        self.robot3.shootmark_pub.publish(point)
        if req.x < -4 and req.y < -4:
            return RefereeShootResponse(5,True)
