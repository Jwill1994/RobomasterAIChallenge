...
def robot_set_goal(robot, robot_move):    
    ...
    if robot.team == 'red':
        value[1][0] = 8-value[1][0]
        value[1][1] = 5-value[1][1]
...
if __name__ == '__main__':
    ...
    robots = ['empty','robot_0', 'robot_2', 'robot_1', 'robot_3']
    team2 = 'red'
    team1 = 'blue'
    ...
    while now < 180:      
        ...
        # ===================================================================================================================================
        #r1
        robot_setting_1(robot1, now, r2_pos, robot3.pos, r4_pos, ez[1], mc[1], eo[1], wc[1], cz[1])
        ...
        print('r3_behav', r3_behav, 'pos : ', round(r3_score,2), np.round(robot3.pos,2), 'Max :' , round(r3_value[0],2), np.round(r3_value[1],2), 'ammo', robot3.ammo)

        print(r1_report, r3_report)        
