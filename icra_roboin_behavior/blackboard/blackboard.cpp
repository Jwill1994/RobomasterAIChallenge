...
//            }
        ...
        if(yolo->enemy_detected[1] == 1){
            ...
            time_enemy_last_seen_ = ros::Time::now();
            time_enemy_1_last_seen_ = ros::Time::now();
            EnemyAlert();
...
//            if(namespace_=="robot_0"||namespace_=="robot_1"){
//            enemy1_cam_pose.header.frame_id="robot_2/base_link";
//            }
//            else if(namespace_=="robot_2"||namespace_=="robot_3"){
//            enemy1_cam_pose.header.frame_id="robot_0/base_link";
//            }
            //enemy1_cam_pose.header.frame_id="camera";
            enemy1_cam_pose.header.stamp = ros::Time::now();
...
//                if(namespace_=="robot_0"||namespace_=="robot_1"){
//                tf_ptr_->transformPose("robot_2/map",enemy1_cam_tf,enemy1_global_tf);
////                ROS_ERROR("4");
//                tf::poseStampedTFToMsg(enemy1_global_tf,enemy1_global_pose);
////                ROS_ERROR("5");
//                enemy_pose_1_ = enemy1_global_pose;
...
//                }
//                else if(namespace_=="robot_2"||namespace_=="robot_3"){
//                tf_ptr_->transformPose("robot_0/map",enemy1_cam_tf,enemy1_global_tf);
////                ROS_ERROR("4");
//                tf::poseStampedTFToMsg(enemy1_global_tf,enemy1_global_pose);
////                ROS_ERROR("5");
//                enemy_pose_1_ = enemy1_global_pose;
...
//                }
        ...
        if(yolo->enemy_detected[2]==1){
            ...
            time_enemy_last_seen_ = ros::Time::now();
            time_enemy_2_last_seen_ = ros::Time::now();
            EnemyAlert();
...
//            enemy2_cam_pose.header.frame_id="camera";
//            if(namespace_=="robot_0"||namespace_=="robot_1"){
//            enemy2_cam_pose.header.frame_id="robot_3/base_link";
//            }
//            else if(namespace_=="robot_2"||namespace_=="robot_3"){
//            enemy2_cam_pose.header.frame_id="robot_1/base_link";
//            }
            enemy2_cam_pose.header.stamp = ros::Time::now();
            ...
            double flat_d =( (float(yolo->distance[2])+ROBOT_PERIMETER)/1000 * std::cos((float(yolo->angle_verti[2]) / 100)*3.141592/180) );  
            ...
            try
            {
                ...
                /*
                if(namespace_=="robot_0"||namespace_=="robot_1"){
                tf_ptr_->transformPose("robot_3/map",enemy2_cam_tf,enemy2_global_tf);
//                ROS_ERROR("7");
                tf::poseStampedTFToMsg(enemy2_global_tf,enemy2_global_pose);
//                ROS_ERROR("8");
                enemy_pose_2_ = enemy2_global_pose;
//                ROS_ERROR("9");
                ...
                tf_ptr_->transformPose("robot_1/map",enemy2_cam_tf,enemy2_global_tf);
//                ROS_ERROR("7");
                tf::poseStampedTFToMsg(enemy2_global_tf,enemy2_global_pose);
//                ROS_ERROR("8");
                enemy_pose_2_ = enemy2_global_pose;
