...
(defsystem "icra_roboin_msgs-msg"
  ...
  :components ((:file "_package")
    (:file "GoalDescription" :depends-on ("_package_GoalDescription"))
    (:file "_package_GoalDescription" :depends-on ("_package"))
    (:file "LockonSpeedControl" :depends-on ("_package_LockonSpeedControl"))
    (:file "_package_LockonSpeedControl" :depends-on ("_package"))
