...
class LockonSpeedControl {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LockonSpeedControl(null);
  ...
  static datatype() {
    ...
    return 'icra_roboin_msgs/LockonSpeedControl';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LockonSpeedControl(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = LockonSpeedControl;
