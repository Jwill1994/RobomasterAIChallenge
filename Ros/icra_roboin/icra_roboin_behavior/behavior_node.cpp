...
int main(int argc, char** argv) {
    ...
    auto lockon_module = new icra_roboin_behavior::LockonModule(0.1); //dt = 0.1
    auto blackboard = new icra_roboin_behavior::Blackboard;



    auto move_behavior = std::make_shared<icra_roboin_behavior::MoveBehavior>(chassis_executor,gimbal_executor,lockon_module,blackboard);
    auto manual_speed_behavior = std::make_shared<icra_roboin_behavior::ManualSpeedBehavior>(chassis_executor,gimbal_executor,lockon_module,blackboard);
    auto manual_accel_behavior = std::make_shared<icra_roboin_behavior::ManualAccelBehavior>(chassis_executor,gimbal_executor,lockon_module,blackboard);
