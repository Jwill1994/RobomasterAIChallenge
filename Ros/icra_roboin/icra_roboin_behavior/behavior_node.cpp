...
int main(int argc, char** argv) {
    ...
    auto lockon_module = new icra_roboin_behavior::LockonModule(blackboard,DT,SENTINEL_ANGLE); //dt = 0.1
    ...
    auto hold_sentinel_behavior = std::make_shared<icra_roboin_behavior::HoldSentinelBehavior>(chassis_executor,gimbal_executor,lockon_module,blackboard);
    ...
    behavior_factory.push_back(std::dynamic_pointer_cast<icra_roboin_behavior::BehaviorBase>(hold_sentinel_behavior));
