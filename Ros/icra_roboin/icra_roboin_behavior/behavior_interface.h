...
class BehaviorInterface {
    public:
        ...
        bool SetEnemyPriorityCB(icra_roboin_msgs::SetEnemyPriority::Request &req, icra_roboin_msgs::SetEnemyPriority::Response &res);
    ...
    private:
        ...
        ros::ServiceServer set_enemy_priority_service_;
